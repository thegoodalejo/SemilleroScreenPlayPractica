...
public class GetWithoutAuthStepDefinitions {
	...
	@Then("I validate that the code {int} and are of page")
	public void iValidateThatTheCodeAndAreOfPage(Integer intStatus) {
		theActorInTheSpotlight().should(seeThatResponse("the page should be correct", response -> response.statusCode(200).body("page", equalTo(2))));
	}
}
