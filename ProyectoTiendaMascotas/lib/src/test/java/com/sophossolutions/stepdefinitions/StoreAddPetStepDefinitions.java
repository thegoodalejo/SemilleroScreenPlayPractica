...
public class StoreAddPetStepDefinitions {
	...
	public void decideThePetByTheDescription(String strPetSelect) {
		theActorInTheSpotlight().wasAbleTo(SaveInfo.on(PET_SELECT.of(strPetSelect)),ClickTo.ElementTarget(BTN_ADD.of(strPetSelect)));
	...
	public void iVerifiedThatThePetIsInTheShoppingCart() {
		theActorInTheSpotlight().should(seeThat(TextOf.in(PET_SELECTED.of(strId)), IsEqual.equalTo(strId)).orComplainWith(ExceptionMessage.class,"Ha ocurrido un error"));
	}
