...
Feature: Make a get request on the reqres web site 
  ...
  Scenario: Make a get request
    Given I want to make an api request on "https://gorest.co.in"
    When I send the request "/public-api/users/" id "2" and resource "/posts"
    Then I check that my response is 200 and total posts