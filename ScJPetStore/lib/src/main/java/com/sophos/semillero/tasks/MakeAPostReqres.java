...
public class MakeAPostReqres implements Task{
	
	private String strEndPoint;
	private Map<String,String> mapData;
	private static final String CONTENT_TYPE="application/json";
	
	public MakeAPostReqres(String strEndPoint,Map<String,String> mapData) {
	...
	public <T extends Actor> void performAs(T actor) {
		actor.attemptsTo(
				Post.to(strEndPoint).with(request -> request.contentType(CONTENT_TYPE).body(mapData)),
	...
	public static MakeAPostReqres withoutAuthentication(String strEndPoint,Map<String,String> strIdUser) {
		return instrumented(MakeAPostReqres.class,strEndPoint,strIdUser);
	}
}
