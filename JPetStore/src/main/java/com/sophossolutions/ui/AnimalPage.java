...
public class AnimalPage {
	public static final Target BTN_ADD_TO_CART_ANIMAL = Target.the("Number of Animals").locatedBy("((//tr[position()>1 and position() < last()])[{0}]//a)[2]");
	public static final Target LINKS_ANIMALS_CAR = Target.the("Number of Animals").locatedBy("//tr[position()>1 and position() < last()]");
	public static final Target LINK_ANIMAL_CAR = Target.the("Number of Animals").locatedBy("(//tr[position()>1 and position() < last()])[{0}]");
